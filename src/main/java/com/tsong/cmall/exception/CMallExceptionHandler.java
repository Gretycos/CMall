package com.tsong.cmall.exception;
...
public class CMallExceptionHandler {
    ...
    public Object handleException(Exception e, HttpServletRequest req) {
        ...
        //区分是否为自定义异常
        if (e instanceof CMallException) {
            ...
            } else if (e.getMessage().equals(ServiceResultEnum.ADMIN_NOT_LOGIN_ERROR.getResult())
                    || e.getMessage().equals(ServiceResultEnum.ADMIN_TOKEN_EXPIRE_ERROR.getResult())) {
